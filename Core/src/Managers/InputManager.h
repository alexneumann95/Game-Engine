...
namespace Managers {
	...
	class GE_API InputManager final : public Manager
	{
	public:
		InputManager();
	...
	private:
		...
		static bool m_MouseButtonStates[10];
...
#define INPUT_MANAGER Managers::InputManager::Instance()
...
/* Modifier keys */
/* Bits are set if one or more of the modifier key were held down */
